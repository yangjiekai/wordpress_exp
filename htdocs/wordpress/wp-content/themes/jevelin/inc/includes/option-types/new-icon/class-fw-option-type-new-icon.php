...
class FW_Option_Type_NewIcon extends FW_Option_Type
{
	...
	protected function _enqueue_static($id, $option, $data)
	{
		...
		if (isset($sets[ $option['set'] ])) {
			...
			if (!isset($this->enqueued_font_styles[ $style_hash ])) {
				wp_enqueue_style(
					"jevelin-option-type-{$this->get_type()}-font-{$option['set']}",
					$set['font-style-src'],
					array(),
					fw()->manifest->get_version()
				);
	...
	private function generate_unknown_set($icon)
	{
		return array(
			...
			'container-class' => '',
			'groups' => array(
				'unknown' => esc_html__('Unknown Set', 'jevelin'),
			),
			'icons' => array(
	...
	private function get_default_sets()
	{
		...
		//     groups => array(
		//         array(
		//             'title' => esc_htm__('Web Application Icons', 'jevelin')
		//             'icons' => array('fa fa-adjust', 'fa fa-anchor', ...),
		//         ),
		//         array(
		//             'title' => esc_html__'Transportation Icons', 'jevelin'),
		//             'icons' => array(...),
		//         ),
		//     )
		//
		...
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups' => array(
					'web-application' => esc_html__('Web Application Icons', 'jevelin'),
					'hand'            => esc_html__('Hand Icons', 'jevelin'),
					'transportation'  => esc_html__('Transportation Icons', 'jevelin'),
					'gender'          => esc_html__('Gender Icons', 'jevelin'),
					'file-type'       => esc_html__('File Type Icons', 'jevelin'),
					//'spinner'         => 'Spinner Icons',
					//'form-control'    => 'Form Control Icons',
					'payment'         => esc_html__('Payment Icons', 'jevelin'),
					//'chart'           => 'Chart Icons',
					'currency'        => esc_html__('Currency Icons', 'jevelin'),
					'text-editor'     => esc_html__('Text Editor Icons', 'jevelin'),
					'directional'     => esc_html__('Directional Icons', 'jevelin'),
					'video-player'    => esc_html__('Video Player Icons', 'jevelin'),
					'brand'           => esc_html__('Brand Icons', 'jevelin'),
					'medical'         => esc_html__('Medical Icons', 'jevelin'),
				),
				'icons'  => array(
