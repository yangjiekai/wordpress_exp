...
$woocommerce_options = array(
	...
	'wc_layout_single' => array(
	    'type'  => 'radio',
	    'value' => 'default',
	    'label' => esc_html__('WooCommerce Layout for Product Page', 'jevelin'),
	...
	'wc_quantity_button' => array(
		'type' => 'switch',
		'label' => esc_html__( 'Jevelin Quantitiy Button', 'jevelin' ),
		'desc' => esc_html__( 'Enable or disable Jevelin quantitiy button (by disabling it could fix some plugin compatibility issues)', 'jevelin' ),
		'value' => 'on',
		'left-choice' => array(
			'value' => 'off',
			'label' => esc_html__('Off', 'jevelin'),
