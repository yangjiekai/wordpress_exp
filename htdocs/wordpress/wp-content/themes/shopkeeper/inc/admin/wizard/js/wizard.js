				...
				doAction.complete(function(e, xhr){ 
					...
					function ( rsp ) { 
						...
						if ( rsp === true ) {
							...
							status = status && true;
							pluginContainer.addClass("parsed").find(".plugin-status").empty().html("<span class=\"state state-success\"></span>");
							pluginContainer.removeClass("loading");

						} else {
							// The action failed for whatever reason
							status = status && false;
							pluginContainer.addClass("parsed").find(".plugin-status").empty().html("<span class=\"state state-error\"></span>");
							pluginContainer.removeClass("loading");
