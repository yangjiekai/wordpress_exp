...
#define PR_BUILD_OPTS " '--prefix=/opt/lampp' '--with-modules=mod_sql:mod_sql_mysql:mod_tls' '--with-includes=/opt/lampp/include:/opt/lampp/include/ncurses' '--with-libraries=/opt/lampp/lib/' 'CC=gcc' 'CFLAGS=-I/opt/lampp/include/c-client -I/opt/lampp/include/libpng -I/opt/lampp/include/freetype2 -O3 -L/opt/lampp/lib -I/opt/lampp/include -I/opt/lampp/include/ncurses' 'LDFLAGS=-Wl,--rpath -Wl,/opt/lampp/lib -L/opt/lampp/lib -I/opt/lampp/include -L/opt/lampp/lib -L/opt/lampp' 'CPPFLAGS=-I/opt/lampp/include/c-client -I/opt/lampp/include/libpng -I/opt/lampp/include/freetype2 -O3 -L/opt/lampp/lib -I/opt/lampp/include -I/opt/lampp/include/ncurses'"

/* Define to be the build CFLAGS.  */
#define PR_BUILD_CFLAGS "-I/opt/lampp/include/c-client -I/opt/lampp/include/libpng -I/opt/lampp/include/freetype2 -O3 -L/opt/lampp/lib -I/opt/lampp/include -I/opt/lampp/include/ncurses -Wall"

/* Define to be the build LDLAGS.  */
#define PR_BUILD_LDFLAGS "-L$(top_srcdir)/lib -Wl,--rpath -Wl,/opt/lampp/lib -L/opt/lampp/lib -I/opt/lampp/include -L/opt/lampp/lib -L/opt/lampp -L/opt/lampp/lib/ -L/opt/lampp/lib"

/* Define to be the build LIBS.  */
#define PR_BUILD_LIBS " -lssl -lcrypto -L$(top_srcdir)/lib/libcap -lcap  -lssl -lcrypto  -lm -lmysqlclient -lz -lsupp -lcrypt -ldl  -ldl"
...
#define PR_CONFIG_DIR "/opt/lampp/etc"
#endif /* PR_CONFIG_DIR */

#ifndef PR_INCLUDE_DIR
#define PR_INCLUDE_DIR "/opt/lampp/include"
#endif /* PR_INCLUDE_DIR */

#ifndef PR_LIBEXEC_DIR
#define PR_LIBEXEC_DIR "/opt/lampp/libexec"
#endif /* PR_LIBEXEC_DIR */

#ifndef PR_LOCALE_DIR
#define PR_LOCALE_DIR "/opt/lampp/share/locale"
#endif /* PR_LOCALE_DIR */

#ifndef PR_RUN_DIR
#define PR_RUN_DIR "/opt/lampp/var"
#endif /* PR_RUN_DIR */

#ifndef PR_CONFIG_FILE_PATH
#define PR_CONFIG_FILE_PATH "/opt/lampp/etc/proftpd.conf"
#endif /* PR_CONFIG_FILE_PATH */

#ifndef PR_PID_FILE_PATH
#define PR_PID_FILE_PATH "/opt/lampp/var/proftpd.pid"
